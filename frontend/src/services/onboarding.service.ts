...
export async function submitOnboardingApi(data: QuizAnswers): Promise<UserPreferences> {
  const res = await apiClient.post<ApiResponse<UserPreferences>>('/onboarding', data);
