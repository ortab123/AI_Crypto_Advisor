...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
  {
    ...
    type: 'multi' as const,
    options: ['Bitcoin (BTC)', 'Ethereum (ETH)', 'Solana (SOL)', 'XRP', 'Dogecoin (DOGE)', 'Other...'],
  },
  {
    ...
    options: ['HODLer', 'Day Trader', 'Swing Trader', 'NFT Collector', 'DeFi Enthusiast', 'Meme Coin Explorer'],
  },
  {
